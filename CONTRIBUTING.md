# Contributing to Frequenz Weather API Client
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/frequenz-client-weather-python/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/frequenz-client-weather/)
   automatically.
